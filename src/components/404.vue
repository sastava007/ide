<template>
  <div id="notFound">
    ...
    <center>
        ...
        <g id="head" class="up">
          <g id="leftAntenna">
            <path
              ...
              d="M 77.519 25.869 C 75.85 13.604 65.745 3.39 53.972 3.14357"
            >
              <animate
                attributeName="d"
                calcMode="spline"
            ...
            <ellipse fill="#ccc" cx="55.021" cy="3.14357" rx="3.344" ry="3.391">
              <animate
                dur="0.75s"
                attributeName="cy"
                calcMode="spline"
          ...
          <g id="rightAntenna">
            <path
              ...
              stroke-width="1.5"
              stroke-miterlimit="10"
              d="M 82.48 25.869 C 84.15 13.604 94.255 3.39 106.028 8.11568"
            >
              <animate
                attributeName="d"
                calcMode="spline"
            ...
            <ellipse fill="#ccc" cx="104.979" cy="8.11568" rx="3.344" ry="3.391">
              <animate
                dur="0.6s"
                attributeName="cy"
                calcMode="spline"
          ...
          <g>
            <g id="eyeLeft">
              <path
                fill="#FFFFFF"
                d="M 72.116 47.955 c 0 5.443 -2.91569 9.853 -9.033 9.853 h -1.971 c -4.988 0 -9.032 -4.41 -9.032 -9.853 s 4.044 -8.44437 9.032 -8.44437 h 1.971 C 68.071 40.0753 72.116 42.512 72.116 47.955 Z"
              >
                <animate
                  attributeName="d"
                  calcMode="spline"
            ...
            <g>
              <path
                fill="#FFFFFF"
                d="M 107.92 47.955 c 0 5.443 -4.045 9.853 -9.031 9.853 h -1.973 c -4.986 0 -9.031 -4.41 -9.031 -9.853 s 4.045 -8.44437 9.031 -8.44437 h 1.973 C 103.875 40.0753 107.92 42.512 107.92 47.955 Z"
              >
                <animate
                  attributeName="d"
                  calcMode="spline"
          ...
          <path
            fill="#FFFFFF"
            d="M 103.383 69.778 c 0 1.381 -0.861465 2.39001 -1.871 2.499 c -11.5625 1.2902 -29.5458 1.76 -43.025 0 c -1.00875 -0.127101 -1.871 -1.118 -1.871 -2.499 c 0 -1.378 0.873886 -2.40151 1.871 -2.496 c 12.377 -0.71066 31.3987 -0.934503 43.025 0 C 102.518 67.3748 103.383 68.4 103.383 69.778 Z"
          >
            <animate
              attributeName="d"
              calcMode="spline"
      ...
      <a href="https://ide.codingblocks.com/">
